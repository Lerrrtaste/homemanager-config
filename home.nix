...
# };
  ...
  programs.bash = {
    ...
    # teams
      ...
      mv = "mv -i";
      mkdir = "mkdir -p";
      ncdu = "ncdu --exclude .git --exclude /mnt --exclude kernfs -L -rr --confirm-quit";
      # lsblk = "lsblk -A -m -o FSUSE%,NAME,FSSIZE,FSAVAIL,MOUNTPOINTS,PARTLABEL";
  ...
  programs.btop = {
    ...
    settings = {
      ...
      shown_boxes = "gpu proc cpu mem net";
      ...
      temp_scale = "celsius";
      disks_filter = "exclude=/boot /nix/store";
 ...
 #services.mopidy = {
  ...
  #   enable = true;
  #   commands = {
  #     idle = "systemctl suspend";
  #     active = "systemctl suspend";
  #   };
  # };
